...
function FooterTop() {
  ...
  return (
		<div className="w-full flex lg:flex-nowrap flex-wrap justify-between xl:gap-[67px] lg:gap-5">
			...
			<div className="md:max-w-[276px] max-w-none lg:mb-0 mb-9">
				...
				<div className="md:mb-8">
					...
					<div className="flex items-center mb-2">
						<span className="mr-2 block">
							<Email className="text-snow" width={24} height={24} />
						</span>
						<a href="mailto:support@artlance.com" className="link-title-1 underline">support@artlance.com</a>
					</div>
					<div className="flex items-center mb-2">
						<span className="mr-2 block">
							<Phone className="text-snow" width={24} height={24} />
						</span>
						<a href="tel:+38 000 000 00 00" className="link-title-1">+38 000 000 00 00</a>
					</div>
				</div>
			</div>

			<div className="lg:w-auto md:w-1/2 w-full lg:mb-0 mb-9">
				<div className="footer__middle-block 2xl:columns-3 columns-2 xl:gap-[65px] lg:gap-5">
					{colLeft.map(item => (
						<Link href={item.path} key={item.labelKey} className="link-title-2 text-snow block md:mb-6 mb-3 w-fit  md:whitespace-nowrap hover:underline">
			...
			<div className="md:w-[375px] w-full">
				<div className="flex items-center md:gap-6 gap-3 mb-8">
					<RegionalSettings />
					<Button variant="secondary" className="h-[56px] flex-1 rounded-5xl" size="lg">
						{/* {isAssesToken
							? (
