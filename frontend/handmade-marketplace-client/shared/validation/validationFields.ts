...
export const password_confirm = yup.string()
    .trim()
    .required("Підтвердження пароля обов'язкове поле")
...
export const agree_terms = yup
  .boolean()
  .oneOf(
    [true],
    "Ви повинні прийняти умови користування та політику конфіденційності."
  )
  .required("Поле згоди є обов'язковим.");